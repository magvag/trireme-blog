...
description: Большинство сайтов придерживается правила «URL-адрес должен работать как навигация по сайту» до первой служебной страницы вроде «/pdfs/file.pdf» — введя просто «/pdfs/», ты получишь 404. Трирема так не поступает.
date: 2025-03-11
taglist:
  - фичи
  - навигация
