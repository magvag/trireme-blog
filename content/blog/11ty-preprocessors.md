...
description: "В Триреме работает очень незаметный автотипограф: он не даёт предлогам висеть в конце строк и размечает, где переносить слова. С помощью нескольких строчек кода вы можете дописать в него свои правила."
date: 2025-03-11
taglist:
  - фичи
  - 11ty
