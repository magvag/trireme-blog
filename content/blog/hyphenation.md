...
description: Давным-давно в вебе решили, что отсутствие переносов слов в интернет-текстах это не баг, а особенность медиума. Потом появились телефоны, текст стал узкой колонкой и его правый край превратился в рванину.
date: 2025-03-12
taglist:
  - фичи
draft: 
...
Я мог бы положиться на браузер, но [hyphenate-limit-chars](https://developer.mozilla.org/en-US/docs/Web/CSS/hyphenate-limit-chars) пока не доступен в Сафари. {.sidenote}
