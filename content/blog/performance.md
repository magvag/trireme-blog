---
title: Перформанс
description: Трирема хорошо оптимизирована. В первую очередь за это стоит благодарить 11ty, во вторую меня — за то, что смог почти ничего не запороть в процессе добавления фич.
date: 2025-03-07
taglist:
  - оптимизация
draft: 
