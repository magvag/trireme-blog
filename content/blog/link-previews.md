...
description: "Повторю: сайты блогов неразрывно связаны с соцсетями. Соцсети же превращают ссылки в карточки-превью — Трирема даёт полный контроль над внешним видом этого превью."
date: 2025-03-10
taglist:
  - фичи
draft: 
